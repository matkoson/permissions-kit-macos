...
private let catalog: [PermissionKind] = [
    ...
    kind(.mediaLibrary, family: .privacy, title: "Media Library", purpose: "Read the Music library.", prompt: .systemPrompt, relaunch: .none, drag: false, usage: ["NSAppleMusicUsageDescription"], entitlements: [], tcc: "kTCCServiceMediaLibrary", anchor: "Privacy_Media"),
