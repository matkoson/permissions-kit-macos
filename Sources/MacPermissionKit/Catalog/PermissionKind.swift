...
private let catalog: [PermissionKind] = [
    ...
    kind(.mediaLibrary, family: .privacy, title: "Media & Apple Music", purpose: "Read the Music library. No in-process grant API is called; request opens Settings.", prompt: .settingsOnly, relaunch: .none, drag: false, usage: ["NSAppleMusicUsageDescription"], entitlements: [], tcc: "kTCCServiceMediaLibrary", anchor: "Privacy_Media"),
    kind(.home, family: .privacy, title: "Home", purpose: "Access Home / HomeKit. macOS has no public in-process probe; request opens Settings, then Refresh.", prompt: .settingsOnly, relaunch: .none, drag: false, usage: ["NSHomeKitUsageDescription"], entitlements: [], tcc: nil, anchor: "Privacy_HomeKit"),
